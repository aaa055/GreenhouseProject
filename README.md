...
<p>
<b><i>Сначала надо установить</i></b> в Arduino IDE необходимые библиотеки (они в папке <b>LibrariesUsed</b> проекта), затем переходить к следующему шагу. Как устанавливать библиотеки в Arduino IDE - гугль знает.
<p>
