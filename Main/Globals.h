...
//#define SAVE_RELAY_STATES // раскомментировать, если в состоянии модуля надо хранить актуальное состояние каналов реле (ещё не понял - надо ли показывать это в реале)
