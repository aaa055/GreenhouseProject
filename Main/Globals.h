...
#define SCREEN_BACKLIGHT_PIN 3 // номер пина, на котором будет управление подсветкой (пин с ШИМ !!!)
...
// #define WAIT_SCREEN_SENSORS W_S(StateTemperature,0,"STATE","Tнаруж") ,W_S(StateTemperature,1,"STATE","Tвнутр") ,W_S(StateLuminosity,0,"LIGHT","свет") ,W_S(StateHumidity,0,"HUMIDITY","влажность")
...
#define WAIT_SCREEN_SENSORS W_S(StateTemperature,0,"STATE","T снаружи") ,W_S(StateHumidity,0,"HUMIDITY","Влажность") ,W_S(StateLuminosity,0,"LIGHT","Освещенность")
